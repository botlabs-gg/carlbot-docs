...
| **massban** [days=2] <members...><br><span class="user-permissions">Ban Members</span>                  | `!massban @Carl-bot @John`        | Bans multiple members. There is a cooldown of 2x command usage per hour.                                                                                           |
